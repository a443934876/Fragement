    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rowid!=-1){
                    Toast.makeText(MainActivity.this, "数据添加成功"+rowid+"行", Toast.LENGTH_SHORT).show();
                    refreshData();
                }else {
                    Toast.makeText(MainActivity.this, "数据添加失败", Toast.LENGTH_SHORT).show();
                }
                ...
                public void onClick(View view) {
                    ...
                    builder.setPositiveButton("删除", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int which) {
                            ...
                            if (count>0){
                                Toast.makeText(MainActivity.this, "数据被删除了"+count+"个", Toast.LENGTH_SHORT).show();
                                refreshData();
                            }else {
